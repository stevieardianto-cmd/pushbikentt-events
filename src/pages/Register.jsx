...
const CLASSES = [
  { id:'K1',  label:'K1 — Siput (2 thn)' },
  { id:'K2',  label:'K2 — Pro (2-3 thn)' },
  { id:'K3',  label:'K3 — ¾ Wheel (2 thn)' },
  { id:'K4',  label:'K4 — Campuran (3 thn)' },
  { id:'K5',  label:'K5 — Pro (3-4 thn)' },
  { id:'K6',  label:'K6 — Pemula (4 thn)' },
  { id:'K7',  label:'K7 — Pro (4-5 thn)' },
  { id:'K8',  label:'K8 — Boys/Girls (5 thn)' },
  { id:'K9',  label:'K9 — Pro (5-6 thn)' },
  { id:'K10', label:'K10 — Rockie (2-3 thn)' },
  { id:'K11', label:'K11 — Girls (4 thn)' },
  { id:'K12', label:'K12 — Girls (5 thn)' },
  { id:'K13', label:'K13 — Girls (6-7 thn)' },
  { id:'K14', label:'K14 — Campuran (6 thn)' },
  { id:'K15', label:'K15 — Rockie (4-5 thn)' },
  { id:'K16', label:'K16 — Girls (7-8 thn)' },
  { id:'K17', label:'K17 — Pro (6-7 thn)' },
  { id:'K18', label:'K18 — Pro (7-8 thn)' },
  { id:'K19', label:'K19 — FFA (Free For All)' },
]
